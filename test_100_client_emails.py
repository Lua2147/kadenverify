...
print()
print("📈 Comparison:")
print(f"   vs Pure Apollo:      ${len(test_emails) * 0.10:.2f} (saved ${len(test_emails) * 0.10 - total_cost:.2f})")
print(f"   vs OmniVerifier:     ${len(test_emails) * 0.046:.2f} (saved ${len(test_emails) * 0.046 - total_cost:.2f})")
